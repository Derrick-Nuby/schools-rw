...
import { getAllSchools, getSingleSchool, createSchool, updateSchool, deleteSchool, getAllSchoolsWithDetails } from "../controllers/school.js";
...
router.get("/details", getAllSchoolsWithDetails);
